...
- **If GitHub Actions warns about deprecated Node 20 actions, that warning is about the internal runtime used by a GitHub Action, not this template's configured Node.js version for building the site.** This template currently builds with Node 22.
