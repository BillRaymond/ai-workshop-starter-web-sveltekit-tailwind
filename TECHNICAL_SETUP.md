...
This repository contains the default SvelteKit starter scaffolded with the current Svelte CLI, TypeScript, and Tailwind CSS using the official Tailwind Vite plugin integration. The project uses a shared multi-stage `Dockerfile` for both VS Code Dev Containers and generic OCI/Docker deployment.
